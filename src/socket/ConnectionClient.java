	...
	public void start() throws IOException, InterruptedException {
		...
		for(int x=0;x<7;x++)
		{
			for(int y=0;y<7;y++)
			{
				...
				String zuSendendeNachricht = "<map><name>ichj</name><pos>"+x*5+","+y*5+"</pos><direction>0,0</direction><data>10,10</data></map>"; // direction sind cm daraus ergibt sich der alpha
