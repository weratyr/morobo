...
public class ConnectionClient {
	...
	public void start() throws IOException {
		...
		while ( i < 15) {
			...
			String zuSendendeNachricht = "<map><info><name>Ketten</name><pos>"+(8+i)+","+((i*2)+2)+"</pos><direction>3,6</direction><data>8,7</data><data>10,5</data><data>23,4</data><data>"+i+",3</data></info></map>";
