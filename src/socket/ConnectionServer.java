...
public class ConnectionServer implements Runnable {
	...
	public void readMessage(Socket socket)  {
		...
		int numberOfChar = bufferedReader.read(buffer, 0, 4); // 
		int toReceiveLength;
